...
String name=(String)session.getAttribute("sname");
	...
	ResultSet rs = null;
		String sql=null;
	 sql = "select uid,name,fid,fname,fsize, date,status,b1 from filestore where fid ='"+fid+"'";
...
<div id="outer"> 
  <div id="header"> 
    <div id="headercontent"> 
      <h1>Enhanced Key Authentication &amp; Authorization for Trusted Cloud Computing</h1>
    </div>
  </div>
  <div id="headerpic">
  </div>
  <div id="menu"> 
    ...
    <ul>
      <li><a href="abe_home.jsp" >Cloud server1 Home</a></li>
  ...
  <div id="content"> 
    ...
    <div id="primarycontainer"> 
      ...
      <div class="box"> 
        <form name="a" action="abe_update1.jsp" method="post">
  ...
  <div id="footer"> 
    <div class="left"><strong><font color="#990033" face="Geneva, Arial, Helvetica, sans-serif"> 
      </font></strong></div>
